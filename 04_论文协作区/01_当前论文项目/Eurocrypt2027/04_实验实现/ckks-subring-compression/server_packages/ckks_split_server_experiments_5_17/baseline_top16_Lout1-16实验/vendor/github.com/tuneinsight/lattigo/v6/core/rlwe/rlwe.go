...
type EvaluatorProvider interface {
	...
	GadgetProductSinglePAndBitDecompLazyHoisted(levelQ int, cx []VectorQP, gadgetCt *GadgetCiphertext, ctQP *Element[ringqp.Poly])
	DecomposeSinglePAndBitDecomp(levelQ, levelP int, c1 ring.Poly, isNTT bool, gadgetCt *GadgetCiphertext, BuffDecompQPPtr *[]VectorQP)
}
