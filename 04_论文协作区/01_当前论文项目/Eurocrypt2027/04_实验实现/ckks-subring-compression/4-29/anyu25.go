...
func RunAnyu25(nRepeat int) (avgL1Err float64, avgTotal time.Duration) {
	...
	// Stream output line by line and capture summary values.
	scanner := bufio.NewScanner(stdout)
	for scanner.Scan() {
		line := scanner.Text()
		fmt.Println(line)

		// Parse: "Avg L1 error is 19.496390"
		...
		// Parse: "Avg time... ModUp: Xms, CtS: Xs, EvalMod: Xs, StC: Xs, Total: 40.541679291s"
